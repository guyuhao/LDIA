...
from dataset.utils import generate_loaders, auxiliary_test_partition, \
    get_dataset_labels, client_split
...
def load_data(name, args,
    ...
    """
    load train or test data of MNIST from local file
    ...
    if probability_list is None:
        probability_list = []
    dataset_path = '../../data'
    dataset = torchvision.datasets.MNIST(root=dataset_path,
...
def get_dataloader(args, shadow_non_iid=None, quantity=None):
    """
    generate loaders of MNIST dataset
