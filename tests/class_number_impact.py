"""
evaluate the impact of the number of classes in LDIA
"""
import copy
import logging
import os
...
class_number_list = [5] + list(range(10, 51, 10))
...
if __name__ == '__main__':
    ...
    for i, class_number in enumerate(class_number_list):
        ...
        logging.warning('class number: {}, LDIA attack: kld {}, chebyshev {}, cos {}'.format(
            class_number, result[0], result[1], result[2]))
