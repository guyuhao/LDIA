"""
evaluate the impact of the number of observed rounds on LDIA
"""
import copy
import logging
import os
...
if __name__ == '__main__':
    ...
    rounds_list = [1] + list(range(5, args['rounds'] + 1, 5))
    for i, rounds in enumerate(rounds_list):
        result = ldia_attack.attack(
            ...
            target_rounds=list(range(rounds))
        )

        logging.warning('rounds: {}, LDIA attack: kld {}, chebyshev {}, cos {}'.format(
            rounds, result[0], result[1], result[2]))
